...
{{--@dd($categories)--}}
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">@lang('admin.projects')</span>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <a href="{{locale_route('project.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.createbutt')</a>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('project.edit',$item->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>
                                                <a href="{{locale_route('project.destroy',$item->id)}}"
