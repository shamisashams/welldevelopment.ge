        ...
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                    $prod_attr = \Illuminate\Support\Arr::pluck($model->attribute_values,'integer_value','attribute_id');
                    $prod_attr_bool = \Illuminate\Support\Arr::pluck($model->attribute_values,'boolean_value','attribute_id');
