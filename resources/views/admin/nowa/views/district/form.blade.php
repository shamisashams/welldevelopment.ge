...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$model->created_at ? __('admin.district-update') : __('admin.district-create')}}</span>
        </div>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">@lang('admin.cities')</label>
