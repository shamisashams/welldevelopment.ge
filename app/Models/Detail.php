...
use App\Models\Translations\DetailTranslation;
...
class Detail extends Model
{
    ...
    /** @var string */
    protected $translationModel = DetailTranslation::class;
   ...
   public function projects(): BelongsToMany{
    ...
    public function apartments(): BelongsToMany{
        return $this->belongsToMany(Apartment::class,'project_details');
    }
