						...
						return function(data, textStatus, jqXHR) {
							...
							if (jqXHR.status == 200) {
								...
								if (editor.config.srcSet){
									...
									imgElem = '<div class="w-full rounded-xl mb-6 h-fit overflow-hidden"><img src="' + url + '" class="image-editor" srcset="'+ srcSet +'" data-width="' + inputWidth + '" data-height="' + inputHeight + '" height="' + height + '" width="' + width + '"></div>'
								} else{
									imgElem = '<div class="w-full rounded-xl mb-6 h-fit overflow-hidden"><img src="' + url + '" class="image-editor" data-width="' + inputWidth + '" data-height="' + inputHeight + '" height="' + height + '" width="' + width + '"></div>'
								}
